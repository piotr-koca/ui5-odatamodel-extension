		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ODataModelExt",
									"targetURL": "#testodatamodelext-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"testodatamodelext-display": {
								"semanticObject": "testodatamodelext",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=testodatamodelext",
									"url": sap.ui.require.toUrl("testodatamodelext")
								}
							}
						}
					}
